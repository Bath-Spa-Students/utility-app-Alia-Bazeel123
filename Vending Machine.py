...
'''
item = {1: {'item_category': 'Cleansing wounds', 'item_name': 'Antiseptic pads', 'item_code': '001', 'price': '15.00', 'stock':'50'}, 
        2: {'item_category': 'Dressings wounds', 'item_name': 'Medical tape', 'item_code': '002', 'price': '5.00', 'stock':'15'}, 
        3: {'item_category': 'Disinfectants', 'item_name': 'Hand sanitizer', 'item_code': '003', 'price': '11.00', 'stock':'10'},
        4: {'item_category': 'Dressings wounds', 'item_name': 'Elastic bandages', 'item_code': '004', 'price': '8.00', 'stock':'20'},
        5: {'item_category': 'Protection', 'item_name': 'Sterile gloves', 'item_code': '005', 'price': '6.00', 'stock':'100'},
        6: {'item_category': 'Treat dehydration', 'item_name': 'Oral Rehydration Solution', 'item_code': '006', 'price': '3.00', 'stock':'75'},
        6: {'item_category': 'Treat dehydration', 'item_name': 'Water', 'item_code': '007', 'price': '2.00', 'stock':'25'}}
print("Hi there!!!")
'''
